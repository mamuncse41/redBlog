...
<head>
    ...
    <script src="{{asset('adminAssets/js/screenfull.js')}}"></script>
    <script>
$(function () {
    ...
    <link rel="stylesheet" href="{{asset('adminAssets/css/morris.css')}}">
    <!-- //charts -->
    <!--skycons-icons-->
    <script src="{{asset('adminAssets/js/skycons.js')}}"></script>
    <!--//skycons-icons-->
    <!-----table----->
    <link rel="stylesheet" type="text/css" href="{{asset('adminAssets/css/table-style.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{asset('adminAssets/css/basictable.css')}}" />
    <script type="text/javascript" src="{{asset('adminAssets/js/jquery.basictable.min.js')}}"></script>
...
if (theme !== 'default')
    ...
    <nav class="main-menu">
        <ul>
            ...
            <li class="has-subnav">
                ...
                <ul>
                    <li class="@yield('catagory_add')">
                        <a class="subnav-text" href="{{url('/addCatagory')}}">
                            Add Catagory
                        </a>
                    </li>
                    <li>
                        <a class="subnav-text" href ="{{url('/manageCatagory')}}">            
                            ManageCatagory
                        </a>
                    </li>
                </ul>
            ...
            <li class="has-subnav">
                ...
                <ul>
                    <li>
                        <a class="#" href="{{url('/add-post')}}">Add Post</a>
                    </li>
                    <li>
                        <a class="subnav-text" href="{{url('/manage-post')}}">Manage Post</a>
                    </li>
                </ul>
            </li>
            <li class="has-subnav">
    ...
    <section class="wrapper scrollable">
        ...
        <section class="title-bar">
            <div class="logo">
                <h1><a href="{{url('/Admin')}}"></a>@yield('page_title')</h1>
            </div>
                            ...
                            <li class="dropdown profile_details_drop">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                    <div class="profile_img">	
                                        <span class="prfil-img"><?php echo Session::get('admin_name'); ?><i class="fa fa-user" aria-hidden="true"></i></span> 
                                        <div class="clearfix"></div>	
                                    </div>	
                                </a>
